...
public class Transformer {
	...
	//@NetworkMod(clientSideRequired=true) // not used in 1.7
	        ...
	        public void load(FMLInitializationEvent event) {
	            	...
	            	GameRegistry.addRecipe(oakWood64, "xxx", "xyx", "xxx", 'x', spruceWood, 'y', oakTransformer.setContainerItem(oakTransformer));
	            	GameRegistry.addRecipe(oakWood64, "xxx", "xyx", "xxx", 'x', acadiaWood, 'y', oakTransformer.setContainerItem(oakTransformer));
	            	GameRegistry.addRecipe(oakWood64, "xxx", "xyx", "xxx", 'x', birchWood, 'y', oakTransformer.setContainerItem(oakTransformer));
	            	GameRegistry.addRecipe(oakWood64, "xxx", "xyx", "xxx", 'x', darkoakWood, 'y', oakTransformer.setContainerItem(oakTransformer));
	            	GameRegistry.addRecipe(oakWood64, "xxx", "xyx", "xxx", 'x', jungleWood, 'y', oakTransformer.setContainerItem(oakTransformer));
	            	GameRegistry.addRecipe(spruceWood64, "xxx", "xyx", "xxx", 'x', oakWood, 'y', spruceTransformer.setContainerItem(spruceTransformer));
	            	GameRegistry.addRecipe(spruceWood64, "xxx", "xyx", "xxx", 'x', acadiaWood, 'y', spruceTransformer.setContainerItem(spruceTransformer));
	            	GameRegistry.addRecipe(spruceWood64, "xxx", "xyx", "xxx", 'x', birchWood, 'y', spruceTransformer.setContainerItem(spruceTransformer));
	            	GameRegistry.addRecipe(spruceWood64, "xxx", "xyx", "xxx", 'x', darkoakWood, 'y', spruceTransformer.setContainerItem(spruceTransformer));
	            	GameRegistry.addRecipe(spruceWood64, "xxx", "xyx", "xxx", 'x', jungleWood, 'y', spruceTransformer.setContainerItem(spruceTransformer));
	            	GameRegistry.addRecipe(birchWood64, "xxx", "xyx", "xxx", 'x', jungleWood, 'y', birchTransformer.setContainerItem(birchTransformer));
	            	GameRegistry.addRecipe(birchWood64, "xxx", "xyx", "xxx", 'x', spruceWood, 'y', birchTransformer.setContainerItem(birchTransformer));
	            	GameRegistry.addRecipe(birchWood64, "xxx", "xyx", "xxx", 'x', darkoakWood, 'y', birchTransformer.setContainerItem(birchTransformer));
	            	GameRegistry.addRecipe(birchWood64, "xxx", "xyx", "xxx", 'x', oakWood, 'y', birchTransformer.setContainerItem(birchTransformer));
	            	GameRegistry.addRecipe(birchWood64, "xxx", "xyx", "xxx", 'x', acadiaWood, 'y', birchTransformer.setContainerItem(birchTransformer));
	            	GameRegistry.addRecipe(jungleWood64, "xxx", "xyx", "xxx", 'x', acadiaWood, 'y', jungleTransformer.setContainerItem(jungleTransformer));
	            	GameRegistry.addRecipe(jungleWood64, "xxx", "xyx", "xxx", 'x', spruceWood, 'y', jungleTransformer.setContainerItem(jungleTransformer));
	            	GameRegistry.addRecipe(jungleWood64, "xxx", "xyx", "xxx", 'x', oakWood, 'y', jungleTransformer.setContainerItem(jungleTransformer));
	            	GameRegistry.addRecipe(jungleWood64, "xxx", "xyx", "xxx", 'x', darkoakWood, 'y', jungleTransformer.setContainerItem(jungleTransformer));
	            	GameRegistry.addRecipe(jungleWood64, "xxx", "xyx", "xxx", 'x', birchWood, 'y', jungleTransformer.setContainerItem(jungleTransformer));
	            	GameRegistry.addRecipe(darkoakWood64, "xxx", "xyx", "xxx", 'x', birchWood, 'y', darkoakTransformer.setContainerItem(darkoakTransformer));
	            	GameRegistry.addRecipe(darkoakWood64, "xxx", "xyx", "xxx", 'x', oakWood, 'y', darkoakTransformer.setContainerItem(darkoakTransformer));
	            	GameRegistry.addRecipe(darkoakWood64, "xxx", "xyx", "xxx", 'x', spruceWood, 'y', darkoakTransformer.setContainerItem(darkoakTransformer));
	            	GameRegistry.addRecipe(darkoakWood64, "xxx", "xyx", "xxx", 'x', jungleWood, 'y', darkoakTransformer.setContainerItem(darkoakTransformer));
	            	GameRegistry.addRecipe(darkoakWood64, "xxx", "xyx", "xxx", 'x', acadiaWood, 'y', darkoakTransformer.setContainerItem(darkoakTransformer));
	            	GameRegistry.addRecipe(acadiaWood64, "xxx", "xyx", "xxx", 'x', birchWood, 'y', acadiaTransformer.setContainerItem(acadiaTransformer));
	            	GameRegistry.addRecipe(acadiaWood64, "xxx", "xyx", "xxx", 'x', darkoakWood, 'y', acadiaTransformer.setContainerItem(acadiaTransformer));
	            	GameRegistry.addRecipe(acadiaWood64, "xxx", "xyx", "xxx", 'x', oakWood, 'y', acadiaTransformer.setContainerItem(acadiaTransformer));
	            	GameRegistry.addRecipe(acadiaWood64, "xxx", "xyx", "xxx", 'x', spruceWood, 'y', acadiaTransformer.setContainerItem(acadiaTransformer));
	            	GameRegistry.addRecipe(acadiaWood64, "xxx", "xyx", "xxx", 'x', jungleWood, 'y', acadiaTransformer.setContainerItem(acadiaTransformer));
